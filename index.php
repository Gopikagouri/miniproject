  ...
  <header>
    ...
    <div class="title-container container-fluid">
      ...
      <div class="logo-title">
        <h3>CAREER GUIDANCE AND PLACEMENT CELL</h3>
      ...
      <div class="sidebar offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
            ...
            <li class="nav-item mx-2">
              <a class="nav-link" href="Entrollment_payment_1.php">Enrollment & Payment Hub</a>
            </li>
            <li class="nav-item mx-2">
              <a class="nav-link" href="#">Placement Statistics</a>
            </li>
            <li class="nav-item mx-2">
              <a class="nav-link" href="Placement_event_1.php">Placement Events Planner</a>
            </li>
            <li class="nav-item mx-2">
